    ...
    async def rules(self, ctx, msg):
        ...
        if msg == 'unverified':
            ...
            NSFW = f"**STRICTLY NO** NSFW content. Use of this kind of content **WILL** result in you having warnings or " \
                   f"possibly a kick/ban, depending on how severe the content is. Part1 is: {pss[0]}. This server is " \
                   f"PG 13 "
            ...
            unjust = f"If you feel like a strike/warning is unjustified, please contact staff and they will assist " \
                     ...
                     f"to reach out to one of the owners. Part 2: {pss[1]} "
            ...
            vents.set_footer(text="These are very strict rules about this to safeguard us all.",
            ...
            await guild.get_channel(929137122588385301).purge(limit=10)
            await guild.get_channel(929137122588385301).send(embed=image)
            await guild.get_channel(929137122588385301).send(embed=rules)
            await guild.get_channel(929137122588385301).send(embed=nsfw)
            await guild.get_channel(929137122588385301).send(embed=warning)
            await guild.get_channel(929137122588385301).send(embed=vents)
            await guild.get_channel(929137122588385301).send(embed=spamm)
            await guild.get_channel(929137122588385301).send(embed=unjustified)
            await guild.get_channel(929137122588385301).send(embed=revised)
            await ctx.send("Sent the normal rules.", delete_after=5)
        ...
        if msg == 'verified':
            ...
            NSFW = f"**STRICTLY NO** NSFW content. Use of this kind of content **WILL** result in you having warnings or " \
                   f"possibly a kick/ban, depending on how severe the content is. This server is PG 13 "
