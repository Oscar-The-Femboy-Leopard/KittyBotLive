...
aliases = ['cardboardsign', 'cb_s']
description = "Put something on a cardboard sign!"
...
class ImgFlip(commands.Cog):
    ...
    async def cardboard_sign(self, ctx, *, message):
        ...
        rm_url = discord.Embed(color=color, title="cardboard sign", timestamp=datetime.datetime.utcnow())
