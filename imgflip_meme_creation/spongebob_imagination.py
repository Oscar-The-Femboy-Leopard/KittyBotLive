...
aliases = ['spongeimagination']
description = "Put something in the Imagination rainbow from SpongeBob"
...
class ImgFlip(commands.Cog):
    ...
    async def imagination(self, ctx, *, message):
        content = ctx
        # ctx = content
        id = '163573'
        ...
        rm_url = discord.Embed(color=color, title="SpoungeBob Imagination", timestamp=datetime.datetime.utcnow())
