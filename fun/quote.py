...
description = f"Selects a random quote from {imglink}. Please message the developer if there's any that you wish to " \
              f"be added which hasn't been added from that site as there's still plenty more that can be used."
...
class Fun(commands.Cog):
    ...
    async def quote(self, ctx):
        responses = ['https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/inspirational-quotes-william-james'
